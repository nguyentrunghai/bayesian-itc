...
export MCMC_DIR="/home/tnguye46/bayesian_itc/ubtln59/2.bitc_mcmc_unifP0_lognomLs/repeat_0"
...
# P0
python $SCRIPT --bitc_mcmc_dir $MCMC_DIR --nonlinear_fit_result_file $NONLIN_RES --ordered_experiment_names_1 "$EXPE1"  --parameter "P0" --xlimits "0.010 0.035" 
