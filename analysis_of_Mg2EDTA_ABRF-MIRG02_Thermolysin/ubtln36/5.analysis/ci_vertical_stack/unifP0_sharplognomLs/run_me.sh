...
export MCMC_DIR="/home/tnguye46/bayesian_itc/ubtln36/2.bitc_mcmc_unifP0_sharplognomLs/repeat_0"
...
# DeltaH
python $SCRIPT --bitc_mcmc_dir $MCMC_DIR --nonlinear_fit_result_file $NONLIN_RES --ordered_experiment_names_1 "$EXPE1"  --parameter "DeltaH" --xlimits "-7 -2.5"
